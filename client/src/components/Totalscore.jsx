  ...
  return (
    <div className="w-full">
      ...
      <div className="hidden sm:block">
        <div className="bg-white rounded-2xl shadow-md border-2 border-indigo-200 p-6 relative overflow-hidden w-[90%] max-w-full mt-1 px-4 lg:px-8 mx-auto lg:mr-auto lg:ml-4">
          ...
          <div className="border-t w-full border-gray-200 pt-5">
